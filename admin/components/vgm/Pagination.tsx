...
"use client";
import { usePaginationStore } from "@/app/_custom/paginationStore";
import React from "react";

const Pagination = () => {
  // getting from custom store current page and methods for incrementing and decrementing current page
