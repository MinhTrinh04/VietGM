"use client";
import { CustomButton, SectionTitle } from "@/components/vgm";
...
const LoginPage = () => {
  ...
  return (
    <div className="bg-white">
      <SectionTitle title="Vietgourmet - Ẩm thực truyền thống Việt Nam" path="Quản lý nhà hàng của bạn" />
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8 bg-white component-bg">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-2xl font-normal leading-9 tracking-tight text-gray-900 head">
